# KnowledgeApp 0.4.1 Surface検証パッケージ
...
4. 検証がPASSしたら、`Surface実機テスト計画書_0.4.1.md`を確認します。
5. `Surface実機リハーサル手順_0.4.1.md`の順に操作し、`Surface実機試験結果_0.4.1.md`へ記録します。
...
| `KnowledgeApp_0.4.1_x64-setup.exe` | 本格利用候補版 |
