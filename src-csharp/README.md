...
設計基準は`FAQシステム要件定義書.md` v1.52（1.17）、`FAQシステム基本設計書.md` v1.73（4.6.13）、`ローカルFAQデータ・Git除外詳細設計書.md` v0.75（2.0.8）です。利用者から今回のPCの復元・確認完了を受領し、正式切替を完了しました。会社環境を含む全体試験完了とは区別し、未実施項目は未実施のまま追跡します。
