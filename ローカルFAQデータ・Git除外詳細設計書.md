...
| 版 | 0.42（Surface合成データ試験反映版） |
| 作成日 | 2026-08-08 |
| 上位文書 | `FAQシステム要件定義書.md` v1.30、`FAQシステム基本設計書.md` v1.40 |
...
| Surface検証パッケージ | 準備完了・実機実施待ち | 出所を固定した0.2.0、候補0.3.3、ハッシュ検証、10,000件CSV生成、6桁管理ID、外部HTML、合成画像、手順・結果票を1つのZIPへまとめる。パッケージと実行時データは`target`配下またはSurfaceにだけ置き、Gitへ含めない。 |
